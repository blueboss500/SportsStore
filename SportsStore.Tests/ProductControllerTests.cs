...
namespace SportsStore.Tests
{
    public class ProductControllerTests
    {
        ...
        //NOTE:  Here is the long hand version of the Func<> used below
        //delegate ProductsListViewModel ActLikeAView(ViewResult v);

        //ProductsListViewModel GetModel(ViewResult v)
        //{
        //    return v?.ViewData?.Model as ProductsListViewModel;
        //}
